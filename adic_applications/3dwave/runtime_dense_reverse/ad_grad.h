...
/* Setting independent and dependent 2-D array variables
 * Prototype: void ADIC_SetIndepArray(DERIV_TYPE arrayvar[], arraysize);
 */
#define ADIC_SetIndepMatrix(arrayvar, arraysize1 ,arraysize2)                         \
  {                                                                     \
    int __adic_iCtr1,__adic_iCtr2;                                                    \
    for (__adic_iCtr1 = 0; __adic_iCtr1 < arraysize1; __adic_iCtr1++) {     \
      for (__adic_iCtr2 = 0; __adic_iCtr2 < arraysize2; __adic_iCtr2++) {     \
        ADIC_SetIndep((arrayvar)[__adic_iCtr1][__adic_iCtr2]);                           \
      }                                                                   \
    }                                                                   \
  }

/* Setting independent and dependent 3-D array variables
 * Prototype: void ADIC_SetIndepArray(DERIV_TYPE arrayvar[], arraysize);
 */
#define ADIC_SetIndep3D(arrayvar, arraysize1 ,arraysize2,arraysize3)                         \
  {                                                                     \
    int __adic_iCtr1,__adic_iCtr2,__adic_iCtr3;                                                    \
    for (__adic_iCtr1 = 0; __adic_iCtr1 < arraysize1; __adic_iCtr1++) {     \
      for (__adic_iCtr2 = 0; __adic_iCtr2 < arraysize2; __adic_iCtr2++) {     \
        for (__adic_iCtr3 = 0; __adic_iCtr3 < arraysize3; __adic_iCtr3++) {     \
          ADIC_SetIndep((arrayvar)[__adic_iCtr1][__adic_iCtr2][__adic_iCtr3]);                           \
        }                                                                   \
      }                                                                   \
    }                                                                   \
  }
 ...
 * Prototype: void ADIC_SetIndepArray(DERIV_TYPE arrayvar[], arraysize);
 */
#define ADIC_SetDepMatrix(arrayvar, arraysize1, arraysize2)                         \
  {                                                                     \
    int __adic_iCtr1,__adic_iCtr2;                                                    \
    for (__adic_iCtr1 = 0; __adic_iCtr1 < arraysize1; __adic_iCtr1++) {     \
      for (__adic_iCtr2 = 0; __adic_iCtr2 < arraysize2; __adic_iCtr2++) {     \
        ADIC_SetDep((arrayvar)[__adic_iCtr1][__adic_iCtr2]);                           \
      }                                                                   \
    }                                                                   \
  }
 ...
 * Prototype: void ADIC_SetIndepArray(DERIV_TYPE arrayvar[], arraysize);
 */
#define ADIC_SetDep3D(arrayvar, arraysize1, arraysize2, arraysize3)             \
  {                                                                     \
    int __adic_iCtr1,__adic_iCtr2,__adic_iCtr3;                                      \
    for (__adic_iCtr1 = 0; __adic_iCtr1 < arraysize1; __adic_iCtr1++) {     \
      for (__adic_iCtr2 = 0; __adic_iCtr2 < arraysize2; __adic_iCtr2++) {     \
        for (__adic_iCtr3 = 0; __adic_iCtr3 < arraysize3; __adic_iCtr3++) {     \
          ADIC_SetDep((arrayvar)[__adic_iCtr1][__adic_iCtr2][__adic_iCtr3]);                \
        }                                                                   \
      }                                                                   \
    }                                                                   \
  }
